...
describe("SmallButton", () => {
  ...
  it("should accept a linkUrl and render an anchor instead of button", () => {
    const component = mount(
      generateComponent({ linkUrl: "http://example.com" }),
    );
  ...
  it("should accept a className prop", () => {
    ...
    const linkedComponent = mount(
      generateLinkedComponent({ className: "harambe" }),
    );
  ...
  it("should accept a style prop", () => {
    const component = mount(
      generateComponent({ style: { textTransform: "capitalize" } }),
    );
    const linkedComponent = mount(
      generateLinkedComponent({ style: { textTransform: "capitalize" } }),
    );
