...
describe("Account Icons", () => {
  describe("AmEx Icon", () => {
    it("should exist", () => {
      const amEx = renderer.create(<AccountIcons.AmEx />);
  ...
  describe("Visa Icon", () => {
    it("should exist", () => {
      const visa = renderer.create(<AccountIcons.Visa />);
  ...
  describe("Discover Icon", () => {
    it("should exist", () => {
      const discover = renderer.create(<AccountIcons.Discover />);
  ...
  describe("MasterCard Icon", () => {
    it("should exist", () => {
      const masterCard = renderer.create(<AccountIcons.MasterCard />);
  ...
  describe("Bank Icon", () => {
    it("should exist", () => {
      const bank = renderer.create(<AccountIcons.Bank />);
