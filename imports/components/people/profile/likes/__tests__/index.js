...
import { RenderLikes, LikesContainer } from "../";

jest.mock("../../../../shared/likes-list", () => props =>
  <div>
...
const mockData = {
  likes: {
    loading: false,
    userFeed: ["hello", "world"],
  },
  recentLikes: {
    loading: false,
    recentlyLiked: ["much recent", "so like", "very wow"],
  },
};
