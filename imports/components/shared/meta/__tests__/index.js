...
describe("Meta", () => {
  ...
  it("should override the default title", () => {
    const wrapper = shallow(<Meta title={"This is a Test Title"} />);
    expect(shallowToJson(wrapper)).toMatchSnapshot();
  });
  it("should override the default image", () => {
    const wrapper = shallow(<Meta image={"link to the test image"} />);
    expect(shallowToJson(wrapper)).toMatchSnapshot();
  });
  it("should have an id", () => {
    const wrapper = shallow(<Meta id={"article.id"} />);
    expect(shallowToJson(wrapper)).toMatchSnapshot();
  });
  ...
  it("should call the fabric function", () => {
    ...
    const wrapper = mount(<Meta title="foo" />);
